...
> - 노트북 15W 발열 throttling 때문에 절대 PPS와 드롭 비율이 실행마다 변동한다. 드롭 비율은
>   런별 17~45%다. 정성 결론에는 영향이 없고, 정밀한 절대치는 안정적인 데스크톱에서 다시
>   측정해야 한다.
...
> 위 표에서 드롭이 B2 < B16 < B64로 역전된 것은 발열 confound다. 버퍼가 크면 드롭은 줄어야
> 한다. 어떤 버퍼에서도 지속 드롭한다는 정성 결론은 견고하다.
